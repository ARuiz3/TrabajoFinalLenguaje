...
class Language(models.Model):
    ...
    name = models.CharField(max_length=100, help_text='Enter the book language (e.g. Spanish)')
...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13, unique=True, 
                            help_text='13 Chacters <a href="https://www.isbn-international.org/content/what-isbn">ISBN number</a>')
    ...
    def __str__(self) :
        """String for representing the Model obejct."""
        return self.title
